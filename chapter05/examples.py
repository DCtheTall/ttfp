...
def RunExamples():
  ...
  p_n = Judgement(Context(alpha, x), Statement(Expression(x)))
  ...
  p_kind = Judgement(
      Context(alpha), Statement(KindExpression(PiKind(x, Star())))
  )
  abst_t = AbstRule(x, appl_t.Conclusion(), p_kind)
  print(abst_t)
  print('Abst rule for term:')
  p_typ = Judgement(
      Context(alpha), Statement(TypeExpression(PiType(x, alpha)))
  )
  ...
  p_b = Judgement(
      Context(S, u, P), Statement(KindExpression(PiKind(v, Star())))
  )
  ...
  p_b = Judgement(Context(S, P, u), Statement(TypeExpression(TApply(P, u))))
  print(ConvRule(p_a, p_b))
